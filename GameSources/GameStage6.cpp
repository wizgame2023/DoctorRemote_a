...
//ビューとライトの作成
	...
	void GameStage6::CreateEffect()//エフェクト生成
	{
	...
	//敵の欠片を作成
	void GameStage6::CreateEnemyPiece() {

		vector<vector<Vec3>> vec = {
			{//1			
				Vec3(0.0f,0.1f,-23.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//2
				Vec3(52.0f,0.1f,-64.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//3
				Vec3(70.3f,0.1f,-55.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//4
				Vec3(61.0f,0.1f,-33.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
			},
			{//5
				Vec3(57.0f,0.1f,-14.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//6
				Vec3(69.0f,0.1f,-5.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
			},
			{//7
				Vec3(66.0f,0.1f,6.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//8
				Vec3(-60.0f,0.1f,-6.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//9
				Vec3(-71.0f,0.1f,12.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//10
				Vec3(-58.0f,0.1f,30.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//11
				Vec3(-57.0f,0.1f,-71.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
	...
	void GameStage6::RandamPiecePosition(Vec3 originPosition)//引数を中心にランダムにかけらが置かれる
	{
		int randamCount = 0;
	...
	void GameStage6::CreateEnemyPiece2()
	{
	...
	void GameStage6::CerateBreakEnemyPiece()//壊れる壁の先にあるかけら
	{
		...
		for (int r = 0; r < stageMap.size(); r++)
		{
			for (int c = 0; c < stageMap[0].size(); c++)
			{
				...
				case 13:
					...
					break;
				case 15:
					AddGameObject<Wall>(startPos + pos, Vec3(0.0f, 0.0f, 0.0f), Vec3(140.0f, 10.0f, 1.0f));
					break;
				case 16:
					AddGameObject<Wall>(startPos + pos, Vec3(0.0f, 0.0f, 0.0f), Vec3(1.0f, 10.0f, 140.0f));
					break;
	...
	void GameStage6::SetCollisionSwich(bool ONorOFF)
	{
	}
	...
	void GameStage6::OnCreate() {
		try {
			...
			AddGameObject<RandCreateManager>(L"kakeraMapLevel11.csv", 150, 60);//ランダムにかけらが出るようになる
