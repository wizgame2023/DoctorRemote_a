...
//ビューとライトの作成
	...
	void GameStage7::CreateEffect()//エフェクト生成
	{
	...
	//敵の欠片を作成
	void GameStage7::CreateEnemyPiece() {
	...
	void GameStage7::RandamPiecePosition(Vec3 originPosition)//引数を中心にランダムにかけらが置かれる
	{
		int randamCount = 0;
	...
	void GameStage7::CreateEnemyPiece2()
	{
	...
	void GameStage7::CerateBreakEnemyPiece()//壊れる壁の先にあるかけら
	{
		//BigPieceのPos一覧
		Vec3 Pos[] =
		{
	...
	void GameStage7::CreateMiniMap()
	{
		...
		auto miniMap = AddGameObject<Sprite>(Lenght, Lenght, L"MiniMapStage12", StartPos, 5);//ミニマップ生成
	...
	void GameStage7::SetCollisionSwich(bool ONorOFF)
	{
	}
	...
	void GameStage7::OnCreate() {
		try {
			...
			AddGameObject<RandCreateManager>(L"kakeraMapLevel12.csv", 150, 70);//ランダムにかけらが出るようになる
