...
//ビューとライトの作成
	...
	void GameStage7::CreateEnemy()
	{
		...
		{
		case 0:
			ptrEnemy = AddGameObject<Enemy>(Vec3(57.0f, 0.5f, 45.0f), Vec3(-0.0f, 0.0f, 0.0f), Vec3(0.8f, 0.8f, 0.8f));
			break;
		case 1:
	...
	void GameStage7::CerateBreakEnemyPiece()//壊れる壁の先にあるかけら
	{
		...
		Vec3 Pos[] = { Vec3(10.0f,0.3f,50.0f),Vec3(-55.0f,0.3f,-40.0f),Vec3(-8.0f,0.3f,41.0f),Vec3(53.0f,0.3f,-7.0f),Vec3(6.0f,0.3f,-50.0f),Vec3(-37.0f,0.3f,15.0f) };//BigPieceのPosision一覧
	...
	void GameStage7::CreateMiniMap()
	{
		...
		auto miniMap = AddGameObject<Sprite>(Lenght, Lenght, L"MiniMapStage7", Vec3(640.0f - (Lenght / 2.0f) - 50.0f, 400.0f - (Lenght / 2.0f) - 50.0f, 0.0f), 5);//ミニマップ生成
	...
	void GameStage7::OnCreate() {
		try {
			...
			AddGameObject<RandCreateManager>(L"kakeraMapLevel7.csv", 150, 30);//ランダムにかけらが出るようになる
