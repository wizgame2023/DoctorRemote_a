...
//ビューとライトの作成
	...
	void GameStage7::CreateEnemy()
	{
		...
		EnemyPos.y = 0.5;
		//Enemyのムービーシーン
		AddGameObject<EnemyMovieManager>(Vec3(63.0f, 0.0f, 38.7f), Vec3(20.0f, 0.1f, 30.0f), Vec3(61.2f, 4.0f, 25.0f), EnemyPos);
	...
	void GameStage7::CreateEnemyPiece() {
		...
		vector<vector<Vec3>> vec = {
			{//1			
				Vec3(-34.0f,0.1f,-53.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//2
				Vec3(-41.0f,0.1f,-47.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//3
				Vec3(-35.0f,0.1f,-48.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//4
				Vec3(-65.0f,0.1f,-22.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
			},
			{//5
				Vec3(-67.0f,0.1f,-33.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//6
				Vec3(62.0f,0.1f,-20.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
			},
			{//7
				Vec3(68.0f,0.1f,-13.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//8
				Vec3(65.0f,0.1f,-28.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
	...
	void GameStage7::CerateBreakEnemyPiece()//壊れる壁の先にあるかけら
	{
		...
		Vec3 Pos[] =
		{
			...
			Vec3(-32.0f,0.3f,-23.0f),//3
			Vec3(65.0f,0.3f,12.0f),//4
	...
	void GameStage7::OnCreate() {
		try {
			...
			AddGameObject<RandCreateManager>(L"kakeraMapLevel12.csv", 150, 60);//ランダムにかけらが出るようになる
