...
//ビューとライトの作成
	...
	void GameStage5::CreateEnemy()
	{
		...
		{
		case 0:
			ptrEnemy = AddGameObject<Enemy>(Vec3(-31.0f, 0.5f, -18.5f), Vec3(-0.0f, 0.0f, 0.0f), Vec3(0.8f, 0.8f, 0.8f));
			break;
		case 1:
	...
	void GameStage5::CreateMiniMap()
	{
		...
		auto miniMap = AddGameObject<Sprite>(Lenght, Lenght, L"MiniMapStage5", Vec3(640.0f - (Lenght / 2.0f) - 50.0f, 400.0f - (Lenght / 2.0f) - 50.0f, 0.0f), 5);//ミニマップ生成
	...
	void GameStage5::OnCreate() {
		try {
			...
			AddGameObject<RandCreateManager>(L"kakeraMapLevel5.csv", 150, 30);//ランダムにかけらが出るようになる
