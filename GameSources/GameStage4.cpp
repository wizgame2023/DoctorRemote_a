...
namespace basecross {
	...
	void GameStage4::CreateEnemyPiece() {
		...
		vector<vector<Vec3>> vec = {
			{//1            
				Vec3(-25.0f,0.1f,-33.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//2
				Vec3(27.0f,0.1f,21.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//3
				Vec3(32.0f,0.1f,10.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},			
			{//4
				Vec3(42.0f,0.1f,21.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
			},
			{//5
				Vec3(33.0f,0.1f,1.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//6
				Vec3(37.0f,0.1f,-8.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
			},
			{//7
				Vec3(-22.0f,0.1f,-20.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)

			},
			{//8
				Vec3(-27.0f,0.1f,2.0f),
				Vec3(0.0f,0.0f,0.0f),
				Vec3(2.0f,2.0f,2.0f)
	...
	{
		Vec3 Pos[] = { Vec3(37.5f,0.3f,30.0f),Vec3(-40.0f,0.3f,-45.0f),Vec3(-45.0f,0.3f,10.0f),Vec3(22.5f,0.3f,-35.0f),Vec3(10.0f,0.3f,-45.0f),Vec3(-10.0f,0.3f,-45.0f) };
		...
		{		
			...
			auto Piece = AddGameObject<BigPiece>(Pos[i], Vec3(0.0f, 0.0f, 0.0f), Vec3(3.5f, 3.5f, 3.5f), randMesh);
	...
	void GameStage4::CreateMap()
	{
		...
		for (int r = 0; r < stageMap.size(); r++)
		{
			for (int c = 0; c < stageMap[0].size(); c++)
			{
				...
				{
				case 1:
					AddGameObject<Wall>(startPos + pos, Vec3(0, 0, 0), Vec3(90.0, 10, 1.0));
					break;
				case 2:
					AddGameObject<Wall>(startPos + pos, Vec3(0, 0, 0), Vec3(1.0, 10, 90.0));
					break;
				case 3:
				...
				case 7:
					...
					AddGameObject<Wall>(startPos + pos + Vec3(0.0f, 10.0f, 0.0f), Vec3(0, XMConvertToRadians(90.0f), 0), Vec3(1.0f, 1.0f, 3.0f));
					break;
				case 8:
				...
				case 14:
					AddGameObject<Wall>(startPos + pos, Vec3(0, 0, 0), Vec3(1.0, 10, 53.0));
					break;
				case 15:
					AddGameObject<Wall>(startPos + pos, Vec3(0, 0, 0), Vec3(38.0, 10, 1.0));
					break;
				}
	...
	void GameStage4::CreateMiniMap()
	{
		...
		auto miniMap = AddGameObject<Sprite>(Lenght, Lenght, L"MiniMapStage3", StartPos, 5);
		SetSharedGameObject(L"MiniMap", miniMap);

		auto miniMapPlayer = AddGameObject<MiniMapPlayer>(StartPos, 4.0f, 100.0f, Lenght);
	...
	void GameStage4::OnCreate() {
		try {	
			...
			//敵のかけらを表示
			CreateEnemyPiece();
			AddGameObject<RandCreateManager>(L"kakeraMapLevel3.csv", 100, 30);//ランダムにかけらが出るようになる
			...
			auto joinManager = AddGameObject<JoinManager>(Vec3(0.0f, 0.5f, 0.0f), Vec3(0.0f, 0.5f, -13.0f));
