...
//ビューとライトの作成
	...
	void GameStage4::RandamPiecePosition(Vec3 originPosition)//引数を中心にランダムにかけらが置かれる
	{
		int randamCount = 0;
	...
	void GameStage4::CreateEnemyPiece2()
	{
	...
	void GameStage4::CerateBreakEnemyPiece()//壊れる壁の先にあるかけら
	{
		...
		Vec3 Pos[] = { Vec3(37.5f,0.3f,30.0f),Vec3(-40.0f,0.3f,-45.0f),Vec3(-45.0f,0.3f,10.0f),Vec3(22.5f,0.3f,-35.0f),Vec3(10.0f,0.3f,-45.0f),Vec3(-10.0f,0.3f,-45.0f) };//BigPieceのPosision一覧
	...
	void GameStage4::CreateMiniMap()
	{
		...
		auto miniMap = AddGameObject<Sprite>(Lenght, Lenght, L"MiniMapStage3", StartPos, 5);//ミニマップ生成
	...
	void GameStage4::CollisionActive(bool On)
	{
	...
	void GameStage4::SetCollisionSwich(bool ONorOFF)
	{
	}
