...
//ビューとライトの作成
	...
	void TutorialStage::CreatePlayer()//改善すべき点
	{
		...
		{
		case 0:
			ptrPlayer = AddGameObject<Player>(Vec3(0.0f, 0.5f, 0.0f), Vec3(0.0f, rad, 0.0f));
			break;
		case 1:
	...
	void TutorialStage::CreateMap()
	{
		...
		for (int r = 0; r < stageMap.size(); r++)
		{
			for (int c = 0; c < stageMap[0].size(); c++)
			{
				...
				case 2:
					AddGameObject<Wall>(startPos + pos, Vec3(0, 0, 0), Vec3(1.0, 10, 2.0));
					break;
				...
				case 6:
					...
					break;
				case 7:
					AddGameObject<BlockSecond>(blockStartPos + pos, Vec3(0, 0, 0), Vec3(20.0f, 10.0f, 20.0f));
					break;
				case 8:
