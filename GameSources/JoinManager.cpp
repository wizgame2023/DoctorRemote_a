...
namespace basecross {
		JoinManager::JoinManager(const shared_ptr<Stage>& stagePtr,Vec3 cameraEye,Vec3 cameraAt,Vec3 minRange,Vec3 maxRange,Vec3 playerStartPos,Vec3 TagetPos):
		GameObject(stagePtr),
		m_Time(0.0f),
		m_UpdateFlag(0),
